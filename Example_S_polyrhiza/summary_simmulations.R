...
# Script title: Summary of results from GEMMA on simulated data
# ------------------------------------------------------------------------------
...
# loading data -----------------------------------------------------------------
load("Data/SNPs_simulated.RData")
load("Data/Prop_variance.RData")
# ------------------------------------------------------------------------------
...
## reading matrix
relatedness <- read.table(file = "gemma_random/relatedness.txt", header = TRUE, 
                          sep = "\t")
...
gwscan_files <- list.files(path = "gemma_random", pattern = "assoc.txt$", 
                           full.names = TRUE)
...
gwscan_files <- list.files(path = "gemma_one", pattern = "assoc.txt$", 
                           full.names = TRUE)
...
gwscan_files <- list.files(path = "gemma_five", pattern = "assoc.txt$", 
                           full.names = TRUE)
...
gwscan_files <- list.files(path = "gemma_ten", pattern = "assoc.txt$", 
                           full.names = TRUE)
...
gwscan_files <- list.files(path = "gemma_twenty", pattern = "assoc.txt$", 
                           full.names = TRUE)
...
## writing table
write.csv(summary_gwas, "Summary_gwas_results.csv", row.names = FALSE)
# ------------------------------------------------------------------------------
...
png("Figures/Summary_h2.png", width = 80, height = 60, units = "mm", res = 600)
...
png("Figures/Summary_relatedness.png", width = 80, height = 60, units = "mm",
    res = 600)
...
legend("topright", legend = "Mean and 95% CI       ", bty = "n", inset = -0.04)
...
### random
png("Figures/Summary_gwas_random.png", width = 166, height = 70, units = "mm", 
    res = 600)
...
### one SNP
png("Figures/Summary_gwas_one.png", width = 166, height = 70, units = "mm", 
    res = 600)
par(mar = c(4, 4.5, 0.5, 0.5),  cex = 0.7)
...
### five SNPs
png("Figures/Summary_gwas_five.png", width = 166, height = 70, units = "mm", 
    res = 600)
par(mar = c(4, 4.5, 0.5, 0.5),  cex = 0.7)
...
### ten SNPs
png("Figures/Summary_gwas_ten.png", width = 166, height = 70, units = "mm", 
    res = 600)
par(mar = c(4, 4.5, 0.5, 0.5),  cex = 0.7)
...
### twenty SNPs
png("Figures/Summary_gwas_twenty.png", width = 166, height = 70, units = "mm", 
    res = 600)
par(mar = c(4, 4.5, 0.5, 0.5),  cex = 0.7)
...
save(h2_means, h2_ci, relatedness_mean, relatedness_ci,
     ...
     file = "Summary_all_results.RData")
# ------------------------------------------------------------------------------
